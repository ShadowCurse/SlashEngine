...
class TestLayer : public slash::Layer {
 public:
  ...
  void OnAttach() final {};
  void OnDetach() final {};
  void OnUpdate(slash::TimeStep ts) final {
  }
  void OnEvent(slash::Event &event) final {
...
class TestApp : public slash::Application {
 public:
  TestApp() {
...
slash::Application *slash::CreateApplication() {
  return new TestApp;
}
